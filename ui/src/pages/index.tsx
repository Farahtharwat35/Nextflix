...
const Home = () => {
    return (
        <div className="h-screen pt-16 pl-20 box-border flex flex-col gap-4 overflow-y-auto">
            <Sidebar />
            <Navbar />
            <div className="grid-cols-2 grid gap-4 p-8 box-border overflow-y-auto shrink-0">
